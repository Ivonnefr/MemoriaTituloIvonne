...
public class Articulo {
    ...
    protected double diaRestante;
    protected double calidad;
    private final static int CALIDAD_MAX = 100;
    
    public Articulo(String nombre, double diaRestante, double calidad) {
        this.nombre = nombre;
    ...
    public double getDiaRestante() {
        return diaRestante;
    }

    public void setDiaRestante(double diaRestante) {
